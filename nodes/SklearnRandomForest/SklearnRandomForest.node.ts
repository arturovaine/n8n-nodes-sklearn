...
export class SklearnRandomForest implements INodeType {
  description: INodeTypeDescription = {
    displayName: 'Sklearn Random Forest',
    name: 'sklearnRandomForest',
    icon: 'file:sklearn.svg',
    group: ['transform'],
    version: 1,
    subtitle: '={{$parameter["modelType"]}} - {{$parameter["operation"]}}',
    description: 'Random Forest classifier and regressor using scikit-learn',
    defaults: {
    ...
    properties: [
        ...
        options: [
          {
            name: 'Classifier',
            value: 'classifier',
            description: 'For classification tasks (categorical targets)',
          },
          {
            name: 'Regressor',
            value: 'regressor',
            description: 'For regression tasks (continuous targets)',
          },
        ],
        default: 'classifier',
      },
        ...
        options: [
          {
            ...
            action: 'Train a random forest model',
          },
          {
            name: 'Predict',
            value: 'predict',
      ...
      },
      {
        ...
        default: 0,
        description: 'Maximum depth of trees. 0 means unlimited.',
      },
      {
  ...
  async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
    ...
    try {
      if (operation === 'train') {
        ...
        const modelClass = modelType === 'classifier' ? 'RandomForestClassifier' : 'RandomForestRegressor';
